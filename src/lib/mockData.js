    ...
    const MOCK_PROJECTS = [
        {
            ...
            "longDescription": "Built with Next.js 16, this portfolio showcases my work while featuring an intelligent AI chatbot powered by Google Gemini. The site includes real-time GitHub statistics, project showcases, and an admin dashboard for content management.",
            "category": "web-app",
