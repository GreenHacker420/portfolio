      ...
      <div className="section-container">
        ...
        >
          ...
          <div className="bg-github-dark p-4 rounded-lg overflow-hidden">
              ...
              {Array.from({ length: 52 }, (_, weekIndex) => (
                <div key={`week-${weekIndex}`} className="grid grid-rows-7 gap-1">
                  {Array.from({ length: 7 }, (_, dayIndex) => {
                    ...
                    const intensity = weekend 
                      ? (randomValue > 0.85 ? Math.floor(randomValue * 4) : 0)
                      : (randomValue > 0.5 ? Math.floor(randomValue * 4) : 0);
                    ...
                    const contributionCount = intensity === 0 ? 0 : Math.ceil(intensity * 3);
                    const date = new Date();
            ...
            <div className="flex justify-between mt-2 text-xs text-github-text">
              <span>May</span>
              <span>Jun</span>
              <span>Jul</span>
              <span>Aug</span>
