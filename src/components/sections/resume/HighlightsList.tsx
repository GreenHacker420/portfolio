...
const HighlightsList = () => {
  ...
  const generateNewHighlight = async () => {
    ...
    try {
      // Generate highlight with context about the portfolio
      const resumeContext = "Full Stack Developer with expertise in React, Next.js, TypeScript, Node.js, AI integration, and modern web development practices.";
