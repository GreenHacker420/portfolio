...
export default function GsocEditor({ proposalId }) {
    ...
    const loadVersions = async (targetId = proposalId) => {
    ...
    useEffect(() => {
        const onKeyDown = (event) => {
            ...
            if (!selectedText) {
                setStatusLine("Select text first, then press Cmd/Ctrl+L.");
                return;
            }
    ...
    const saveProposal = async () => {
        ...
        try {
            ...
            if (isNewProposal && savedProposal?.id) {
                router.push(`/admin/gsoc/${savedProposal.id}`);
                return;
            }
    ...
    const runSectionEnhance = async (customInstruction = "") => {
        if (isNewProposal || !selectedSectionKey) return;
        setIsEnhancing(true);
        setStatusLine("");
        try {
    ...
    const runInlineChat = async () => {
        if (!chatInput.trim() || isNewProposal) return;
                ...
                <div className="h-full grid grid-cols-12 gap-4">
                    ...
                    <section className="col-span-12 xl:col-span-7 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4 md:p-5 flex flex-col min-h-0">
                        ...
                        <Textarea
                            ...
                            className="mt-2 flex-1 min-h-[340px] resize-none bg-zinc-950 border-zinc-700 text-zinc-100 leading-relaxed"
                        ...
                        <p className="mt-1 text-[11px] text-zinc-500">Shortcut: Cmd/Ctrl+L adds selected text to chat.</p>
                    </section>
                        ...
                        <div className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-3">
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                <Button
                                    ...
                                    disabled={isNewProposal || isResearching}
                                ...
                                <Button
                                    ...
                                    disabled={isNewProposal || isGeneratingOutline}
                                    onClick={runOutline}
                                >
                                ...
                                <Button
                                    ...
                                    disabled={isNewProposal || !selectedSectionKey || isEnhancing}
                                ...
                                <Button
                                    variant="outline"
                                    className="h-9 justify-start border-zinc-700"
                                    disabled={isNewProposal || isCritiquing}
                                    onClick={runCritique}
                                >
                                ...
                                <Button
                                    variant="outline"
                                    className="h-9 justify-start border-zinc-700"
                                    disabled={isNewProposal || isOptimizingLoop}
                            ...
                            {isNewProposal && (
                                <p className="mt-2 text-[11px] text-zinc-500">Save once to enable AI actions.</p>
                            )}
                        </div>
                            ...
                            <div className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-3 flex flex-col min-h-[220px]">
                                ...
                                <div className="mt-2 flex gap-2">
                                    <Input
                                        ...
                                        className="h-9 bg-zinc-950 border-zinc-700 text-xs"
                                    />
